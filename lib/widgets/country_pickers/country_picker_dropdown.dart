...
import 'package:naturalslim_widgets/assets/countries.dart';
import 'package:naturalslim_widgets/models/country.dart';
import 'package:naturalslim_widgets/utils/typedefs.dart';
import 'package:naturalslim_widgets/utils/utils.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return DropdownButton<Country>(
      ...
      onChanged: (value) {
        if (value != null) {
          setState(() {
            if(value.isoCode != widget.initialValue){
